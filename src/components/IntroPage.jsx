...
const IntroPage = ({ onStart }) => {
  ...
  const messageLines = [
    ...
    "this is not me trying to rekindle anything",
    "this is not to revisit or change any agreements we've made. Our agreement is important to me",
    "I intend to honor those promises as weve discussed until you let me know if theres anything youd like to change",
    "or if you have any new requirements.",
